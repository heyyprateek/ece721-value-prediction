...
//	uint64_t active_list_size;
	...
	/////////////////////////////////////////////////////////////////////
	struct Free_List{
		uint64_t head,tail,t_phase,h_phase;
		std::vector<uint64_t> f_list;
		uint64_t f_list_size;
	}free_list;
	typedef struct branch_checkpoint{
		std::vector<uint64_t> Checkpointed_RMT;
		Free_List Checkpointed_f_list;
		uint64_t Checkpointed_GBM;
	};
	std::vector<branch_checkpoint> br_chkpt;	/////////////////////////////////////////////////////////////////////
	...
	typedef active_list_params active_list_t;
	struct Active_List{ uint64_t head,tail,t_phase,h_phase;
		std::vector<active_list_t> active_list_vec;
	}active_list;
	/////////////////////////////////////////////////////////////////////
	...
	/////////////////////////////////////////////////////////////////////
	std::vector<uint64_t> prf_rdy_bit;
	/////////////////////////////////////////////////////////////////////
