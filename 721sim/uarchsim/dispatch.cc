...
//		// FIX_ME #9 END
      ...
      switch (PAY.buf[index].iq) {
         case SEL_IQ:
            ...
            // FIX_ME #10a BEGIN		
            //printf(" A- val-%0d rdy-%0d reg-%0d B- val-%0d rdy-%0d reg-%0d D- val-%0d rdy-%0d reg-%0d \n",	PAY.buf[index].A_valid,A_ready,PAY.buf[index].A_phys_reg,	PAY.buf[index].B_valid,B_ready,PAY.buf[index].B_phys_reg,PAY.buf[index].D_valid,D_ready,PAY.buf[index].D_phys_reg);
